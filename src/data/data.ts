...
export function _saveQuestion(question: { optionOneText: string, optionTwoText: string, author: string }): Promise<any> {
...
export function _saveQuestionAnswer({ authedUser, qid, answer }: { authedUser: string, qid: string, answer: string }): Promise<boolean> {
  return new Promise((resolve, reject) => {
